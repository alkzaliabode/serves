...
class CreateDailyStatusesTable extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('daily_statuses', function (Blueprint $table) {
            ...
            $table->json('wedding_leaves')->nullable();     // إجازات زفاف
            $table->json('other_leaves')->nullable();       // إجازات أخرى
            $table->json('monthly_hours')->nullable();      // الساعات الشهرية (إذا تم تخزينها يومياً)
