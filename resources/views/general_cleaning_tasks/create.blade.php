...
@section('title', 'إنشاء مهمة نظافة عامة') {{-- تحديد عنوان الصفحة في المتصفح --}}

@section('page_title', 'إنشاء مهمة نظافة عامة جديدة') {{-- عنوان الصفحة داخل AdminLTE Header --}}
    ...
    <div class="container-fluid">
        <div class="card"> {{-- استخدام بطاقة AdminLTE --}}
            ...
            <div class="card-body">
                ...
                <form action="{{ route('general-cleaning-tasks.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{-- تم تضمين قائمة المواقع مباشرة في هذا الملف بناءً على طلبك --}}
                                    <select class="form-select" id="location" name="location" required>
                                        <option value="">اختر الموقع</option>
                                        {{-- القاعات --}}
                                        <option value="قاعة 1 الأسفل" {{ old('location') == 'قاعة 1 الأسفل' ? 'selected' : '' }}>قاعة 1 الأسفل</option>
                                        <option value="قاعة 1 الأعلى" {{ old('location') == 'قاعة 1 الأعلى' ? 'selected' : '' }}>قاعة 1 الأعلى</option>
                                        <option value="قاعة 2 الأسفل" {{ old('location') == 'قاعة 2 الأسفل' ? 'selected' : '' }}>قاعة 2 الأسفل</option>
                                        <option value="قاعة 2 الأعلى" {{ old('location') == 'قاعة 2 الأعلى' ? 'selected' : '' }}>قاعة 2 الأعلى</option>
                                        <option value="قاعة 3 الأسفل" {{ old('location') == 'قاعة 3 الأسفل' ? 'selected' : '' }}>قاعة 3 الأسفل</option>
                                        <option value="قاعة 3 الأعلى" {{ old('location') == 'قاعة 3 الأعلى' ? 'selected' : '' }}>قاعة 3 الأعلى</option>
                                        <option value="قاعة 4 الأسفل" {{ old('location') == 'قاعة 4 الأسفل' ? 'selected' : '' }}>قاعة 4 الأسفل</option>
                                        <option value="قاعة 4 الأعلى" {{ old('location') == 'قاعة 4 الأعلى' ? 'selected' : '' }}>قاعة 4 الأعلى</option>
                                        <option value="قاعة 5 الأسفل" {{ old('location') == 'قاعة 5 الأسفل' ? 'selected' : '' }}>قاعة 5 الأسفل</option>
                                        <option value="قاعة 5 الأعلى" {{ old('location') == 'قاعة 5 الأعلى' ? 'selected' : '' }}>قاعة 5 الأعلى</option>
                                        <option value="قاعة 6 الأسفل" {{ old('location') == 'قاعة 6 الأسفل' ? 'selected' : '' }}>قاعة 6 الأسفل</option>
                                        <option value="قاعة 6 الأعلى" {{ old('location') == 'قاعة 6 الأعلى' ? 'selected' : '' }}>قاعة 6 الأعلى</option>
                                        <option value="قاعة 7 الأسفل" {{ old('location') == 'قاعة 7 الأسفل' ? 'selected' : '' }}>قاعة 7 الأسفل</option>
                                        <option value="قاعة 7 الأعلى" {{ old('location') == 'قاعة 7 الأعلى' ? 'selected' : '' }}>قاعة 7 الأعلى</option>
                                        <option value="قاعة 8 الأسفل" {{ old('location') == 'قاعة 8 الأسفل' ? 'selected' : '' }}>قاعة 8 الأسفل</option>
                                        <option value="قاعة 8 الأعلى" {{ old('location') == 'قاعة 8 الأعلى' ? 'selected' : '' }}>قاعة 8 الأعلى</option>
                                        <option value="قاعة 9 الأسفل" {{ old('location') == 'قاعة 9 الأسفل' ? 'selected' : '' }}>قاعة 9 الأسفل</option>
                                        <option value="قاعة 9 الأعلى" {{ old('location') == 'قاعة 9 الأعلى' ? 'selected' : '' }}>قاعة 9 الأعلى</option>
                                        <option value="قاعة 10 الأسفل" {{ old('location') == 'قاعة 10 الأسفل' ? 'selected' : '' }}>قاعة 10 الأسفل</option>
                                        <option value="قاعة 10 الأعلى" {{ old('location') == 'قاعة 10 الأعلى' ? 'selected' : '' }}>قاعة 10 الأعلى</option>
                                        <option value="قاعة 11 الأسفل" {{ old('location') == 'قاعة 11 الأسفل' ? 'selected' : '' }}>قاعة 11 الأسفل</option>
                                        <option value="قاعة 11 الأعلى" {{ old('location') == 'قاعة 11 الأعلى' ? 'selected' : '' }}>قاعة 11 الأعلى</option>
                                        <option value="قاعة 12 الأسفل" {{ old('location') == 'قاعة 12 الأسفل' ? 'selected' : '' }}>قاعة 12 الأسفل</option>
                                        <option value="قاعة 12 الأعلى" {{ old('location') == 'قاعة 12 الأعلى' ? 'selected' : '' }}>قاعة 12 الأعلى</option>
                                        <option value="قاعة 13 الأسفل" {{ old('location') == 'قاعة 13 الأسفل' ? 'selected' : '' }}>قاعة 13 الأسفل</option>
                                        <option value="قاعة 13 الأعلى" {{ old('location') == 'قاعة 13 الأعلى' ? 'selected' : '' }}>قاعة 13 الأعلى</option>
                                        {{-- المناطق الخارجية --}}
                                        <option value="جميع القواطع الخارجية" {{ old('location') == 'جميع القواطع الخارجية' ? 'selected' : '' }}>جميع القواطع الخارجية</option>
                                        <option value="الترامز" {{ old('location') == 'الترامز' ? 'selected' : '' }}>الترامز</option>
                                        <option value="السجاد" {{ old('location') == 'السجاد' ? 'selected' : '' }}>السجاد</option>
                                        <option value="الحاويات" {{ old('location') == 'الحاويات' ? 'selected' : '' }}>الحاويات</option>
                                        <option value="الجامع" {{ old('location') == 'الجامع' ? 'selected' : '' }}>الجامع</option>
                                        <option value="المركز الصحي" {{ old('location') == 'المركز الصحي' ? 'selected' : '' }}>المركز الصحي</option>
                                    </select>
                                </div>
                            </div>

                            <fieldset id="task-details-fieldset" class="mb-3" style="display: {{ old('location') ? 'block' : 'none' }};">
                                <legend>تفاصيل التنفيذ</legend>
                                <div id="room-fields" class="row mb-3" style="display: none;">
                                    <div class="col-md-3 mb-3"><label for="mats_count" class="form-label">عدد المنادر المدامة</label><input type="number" class="form-control" id="mats_count" name="mats_count" min="0" value="{{ old('mats_count', 0) }}"></div>
                                    <div class="col-md-3 mb-3"><label for="pillows_count" class="form-label">عدد الوسادات المدامة</label><input type="number" class="form-control" id="pillows_count" name="pillows_count" min="0" value="{{ old('pillows_count', 0) }}"></div>
                                    <div class="col-md-3 mb-3"><label for="fans_count" class="form-label">عدد المراوح المدامة</label><input type="number" class="form-control" id="fans_count" name="fans_count" min="0" value="{{ old('fans_count', 0) }}"></div>
                                    <div class="col-md-3 mb-3"><label for="windows_count" class="form-label">عدد النوافذ المدامة</label><input type="number" class="form-control" id="windows_count" name="windows_count" min="0" value="{{ old('windows_count', 0) }}"></div>
                                    <div class="col-md-3 mb-3"><label for="carpets_count" class="form-label">عدد السجاد المدام</label><input type="number" class="form-control" id="carpets_count" name="carpets_count" min="0" value="{{ old('carpets_count', 0) }}"></div>
                                    <div class="col-md-3 mb-3"><label for="blankets_count" class="form-label">عدد البطانيات المدامة</label><input type="number" class="form-control" id="blankets_count" name="blankets_count" min="0" value="{{ old('blankets_count', 0) }}"></div>
                                    <div class="col-md-3 mb-3"><label for="beds_count" class="form-label">عدد الأسرة</label><input type="number" class="form-control" id="beds_count" name="beds_count" min="0" value="{{ old('beds_count', 0) }}"></div>
                                    <div class="col-md-3 mb-3"><label for="beneficiaries_count" class="form-label">عدد المستفيدين من القاعة</label><input type="number" class="form-control" id="beneficiaries_count" name="beneficiaries_count" min="0" value="{{ old('beneficiaries_count', 0) }}"></div>
                                </div>
                                <div id="trams-fields" class="row mb-3" style="display: none;">
                                    <div class="col-md-6 mb-3"><label for="filled_trams_count" class="form-label">عدد الترامز المملوئة والمدامة</label><input type="number" class="form-control" id="filled_trams_count" name="filled_trams_count" min="0" value="{{ old('filled_trams_count', 0) }}"></div>
                                </div>
                                <div id="carpets-laid-fields" class="row mb-3" style="display: none;">
                                    <div class="col-md-6 mb-3"><label for="carpets_laid_count" class="form-label">عدد السجاد المفروش في الساحات</label><input type="number" class="form-control" id="carpets_laid_count" name="carpets_laid_count" min="0" value="{{ old('carpets_laid_count', 0) }}"></div>
                                </div>
                                <div id="containers-fields" class="row mb-3" style="display: none;">
                                    <div class="col-md-6 mb-3"><label for="large_containers_count" class="form-label">عدد الحاويات الكبيرة المفرغة والمدامة</label><input type="number" class="form-control" id="large_containers_count" name="large_containers_count" min="0" value="{{ old('large_containers_count', 0) }}"></div>
                                    <div class="col-md-6 mb-3"><label for="small_containers_count" class="form-label">عدد الحاويات الصغيرة المفرغة والمدامة</label><input type="number" class="form-control" id="small_containers_count" name="small_containers_count" min="0" value="{{ old('small_containers_count', 0) }}"></div>
                                </div>
                                <div id="maintenance-details-fields" class="row mb-3" style="display: none;">
                                    <div class="col-md-12 mb-3"><label for="maintenance_details" class="form-label">تفاصيل الإدامة اليومية</label><textarea class="form-control" id="maintenance_details" name="maintenance_details" rows="3">{{ old('maintenance_details') }}</textarea></div>
                                </div>
                            </fieldset>

                            <fieldset id="external-partitions-fieldset" class="mb-3" style="display: {{ old('location') == 'جميع القواطع الخارجية' ? 'block' : 'none' }};">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="external_partitions_count" name="external_partitions_count" min="0" value="{{ old('external_partitions_count', 0) }}">
                                </div>
                            </fieldset>
                        </div>
                    </div>
                                        ...
                                        <div class="row mb-3 employee-task-item">
                                            ...
                                            <div class="col-md-4 mb-3 mb-md-0">
                                                ...
                                                <select class="form-select" name="employeeTasks[{{ $index }}][employee_rating]" required>
                                                    ...
                                                    <option value="5" {{ ($employeeTask['employee_rating'] ?? '') == '5' ? 'selected' : '' }}>5 - ممتاز</option>
                                                    <option value="4" {{ ($employeeTask['employee_rating'] ?? '') == '4' ? 'selected' : '' }}>4 - جيد جداً</option>
                                                    <option value="3" {{ ($employeeTask['employee_rating'] ?? '') == '3' ? 'selected' : '' }}>3 - جيد</option>
                                                    <option value="2" {{ ($employeeTask['employee_rating'] ?? '') == '2' ? 'selected' : '' }}>2 - مقبول</option>
                                                    <option value="1" {{ ($employeeTask['employee_rating'] ?? '') == '1' ? 'selected' : '' }}>1 - ضعيف</option>
                                                </select>
                                            </div>
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <a href="{{ route('general-cleaning-tasks.index') }}" class="btn btn-secondary ml-2">
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Resources Repeater
            var resourceIndex = {{ old('resources_used') ? count(old('resources_used')) : 0 }};
            ...
            // Employees Repeater
            var employeeTaskIndex = {{ old('employeeTasks') ? count(old('employeeTasks')) : 0 }};
