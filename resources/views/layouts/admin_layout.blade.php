...
<head>
    ...
    {{-- هذا هو ملف CSS المخصص لتحسينات لوحة التحكم. يجب أن يتم تحميله بعد ملفات AdminLTE الأساسية --}}
    <link rel="stylesheet" href="{{ asset('adminlte/css/dashboard_enhancements.css') }}">
