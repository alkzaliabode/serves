...
{{-- هذا الملف يحتوي على شريط التنقل العلوي (Navbar) للتطبيق. --}}

<nav class="app-header navbar navbar-expand glassmorphism-navbar shadow-lg">
    <div class="container-fluid">
        {{-- الروابط اليسرى في شريط التنقل (زر التبديل للشريط الجانبي، روابط الصفحة الرئيسية) --}}
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item d-none d-md-block">
                ...
                <a href="{{ route('home') }}" class="nav-link animated-nav-item glow-on-hover">الرئيسية</a>
            </li>
            {{-- يمكنك إضافة روابط علوية أخرى هنا --}}
        </ul>

        {{-- الروابط اليمنى في شريط التنقل (الإشعارات، قائمة المستخدم، ملء الشاشة) --}}
        {{-- تم إضافة ms-auto لدفع هذه العناصر إلى أقصى اليمين في تصميم RTL --}}
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown animated-nav-item">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end animated-dropdown">
                    ...
                    <div class="dropdown-divider"></div>
                    <a href="{{ route('notifications.index') }}" class="dropdown-item dropdown-footer">عرض كل الإشعارات</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown user-menu animated-nav-item">
                <a href="#" class="nav-link user-profile-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ Auth::user()->profile_photo_url ?? 'https://placehold.co/160x160/cccccc/ffffff?text=U' }}" class="user-image img-circle shadow" alt="User Image">
                    <span class="d-none d-md-inline text-white-shadow">{{ Auth::user()->name ?? 'الضيف' }}</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end animated-dropdown">
                    {{-- صورة المستخدم واسمه في الرأس --}}
                    ...
                    {{-- فوتر قائمة المستخدم (روابط الملف الشخصي وتسجيل الخروج) --}}
                    <li class="user-footer">
                        <a href="{{ route('profile.edit') }}" class="btn btn-default btn-flat profile-btn glow-on-hover">الملف الشخصي</a>
