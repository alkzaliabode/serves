...
@section('title', 'إضافة مستخدم جديد') {{-- تعريف عنوان الصفحة --}}

@section('page_title', 'إضافة مستخدم جديد') {{-- تعريف عنوان الصفحة في AdminLTE Header --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }}> {{-- افتراضيًا نشط عند الإنشاء --}}
                        ...
                        <div class="form-group">
                            ...
                            <select id="roles" name="roles[]" multiple class="form-control select2 @error('roles') is-invalid @enderror" required>
                                {{-- لا توجد خيارات افتراضية لأن المستخدم جديد --}}
