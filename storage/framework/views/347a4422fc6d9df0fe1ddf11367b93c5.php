...
<?php $__env->startSection('title', 'مهام النظافة العامة'); ?>

<?php $__env->startSection('page_title', 'قائمة مهام النظافة العامة'); ?>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?php echo e(route('general-cleaning-tasks.create')); ?>" class="btn btn-primary btn-sm">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('general-cleaning-tasks.index')); ?>" method="GET" class="mb-4">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control" placeholder="بحث بالموقع، الحالة، الهدف، أو المنشئ..." value="<?php echo e(request('search')); ?>">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>التاريخ
                                    <a href="<?php echo e(route('general-cleaning-tasks.index', ['sort_by' => 'date', 'sort_order' => (request('sort_by') == 'date' && request('sort_order') == 'asc' ? 'desc' : 'asc'), 'search' => request('search')])); ?>">
                                        <?php if(request('sort_by') == 'date' && request('sort_order') == 'asc'): ?> &uarr; <?php elseif(request('sort_by') == 'date' && request('sort_order') == 'desc'): ?> &darr; <?php else: ?> &harr; <?php endif; ?>
                                    </a>
                                </th>
                                <th>الوجبة</th>
                                <th>الموقع
                                    <a href="<?php echo e(route('general-cleaning-tasks.index', ['sort_by' => 'location', 'sort_order' => (request('sort_by') == 'location' && request('sort_order') == 'asc' ? 'desc' : 'asc'), 'search' => request('search')])); ?>">
                                        <?php if(request('sort_by') == 'location' && request('sort_order') == 'asc'): ?> &uarr; <?php elseif(request('sort_by') == 'location' && request('sort_order') == 'desc'): ?> &darr; <?php else: ?> &harr; <?php endif; ?>
                                    </a>
                                </th>
                                <th>نوع المهمة</th>
                                <th>الحالة
                                    <a href="<?php echo e(route('general-cleaning-tasks.index', ['sort_by' => 'status', 'sort_order' => (request('sort_by') == 'status' && request('sort_order') == 'asc' ? 'desc' : 'asc'), 'search' => request('search')])); ?>">
                                        <?php if(request('sort_by') == 'status' && request('sort_order') == 'asc'): ?> &uarr; <?php elseif(request('sort_by') == 'status' && request('sort_order') == 'desc'): ?> &darr; <?php else: ?> &harr; <?php endif; ?>
                                    </a>
                                </th>
                                <th>الهدف المرتبط</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php $__empty_2 = true; $__currentLoopData = $task->employeeTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employeeTask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                            <?php echo e($employeeTask->employee->name ?? 'N/A'); ?> (تقييم: <?php echo e($employeeTask->employee_rating); ?>)<br>
                                    ...
                                    <td class="actions">
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('general-cleaning-tasks.edit', $task)); ?>" class="btn btn-info btn-sm" title="تعديل">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('general-cleaning-tasks.destroy', $task)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kadm-drgham\resources\views/general_cleaning_tasks/index.blade.php ENDPATH**/ ?>