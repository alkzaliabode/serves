...
<div class="card card-primary card-outline"> 
    <div class="card-header">
        <h3 class="card-title">
            <?php echo e(isset($dailyStatus) ? 'تعديل الموقف اليومي' : 'إنشاء موقف يومي جديد'); ?>

        </h3>
    </div>
    <div class="card-body">
        <form action="<?php echo e(isset($dailyStatus) ? route('daily-statuses.update', $dailyStatus->id) : route('daily-statuses.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <?php if(isset($dailyStatus)): ?>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" id="date" name="date" value="<?php echo e(old('date', $dailyStatus->date ?? now()->toDateString())); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <p id="hijri_date_display" class="input-group-text-custom">
                                <?php echo e($hijriDate ?? 'سيتم التحديد تلقائياً'); ?>

                            </p>
                            <input type="hidden" id="hijri_date_input" name="hijri_date" value="<?php echo e($hijriDate ?? ''); ?>">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="day_name" class="form-label">اليوم</label>
                            <p id="day_name_display" class="input-group-text-custom">
                                <?php echo e($dayName ?? 'سيتم التحديد تلقائياً'); ?>

                            </p>
                            <input type="hidden" id="day_name_input" name="day_name" value="<?php echo e($dayName ?? ''); ?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div id="periodic_leaves_repeater" class="mb-4">
                        ...
                        <div id="periodic_leaves_container">
                            <?php $periodic_leaves = old('periodic_leaves', $dailyStatus->periodic_leaves ?? []); ?>
                            <?php $__currentLoopData = $periodic_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.employee_leave_item', ['type' => 'periodic_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <div id="annual_leaves_repeater" class="mb-4">
                        ...
                        <div id="annual_leaves_container">
                            <?php $annual_leaves = old('annual_leaves', $dailyStatus->annual_leaves ?? []); ?>
                            <?php $__currentLoopData = $annual_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.employee_leave_item', ['type' => 'annual_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="temporary_leaves_repeater" class="mb-4">
                        ...
                        <div id="temporary_leaves_container">
                            <?php $temporary_leaves = old('temporary_leaves', $dailyStatus->temporary_leaves ?? []); ?>
                            <?php $__currentLoopData = $temporary_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.temporary_leave_item', ['type' => 'temporary_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="eid_leaves_repeater" class="mb-4">
                        ...
                        <div id="eid_leaves_container">
                            <?php $eid_leaves = old('eid_leaves', $dailyStatus->eid_leaves ?? []); ?>
                            <?php $__currentLoopData = $eid_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.eid_leave_item', ['type' => 'eid_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="guard_rest_repeater" class="mb-4">
                        ...
                        <div id="guard_rest_container">
                            <?php $guard_rest = old('guard_rest', $dailyStatus->guard_rest ?? []); ?>
                            <?php $__currentLoopData = $guard_rest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.employee_leave_item', ['type' => 'guard_rest', 'index' => $index, 'leave' => $rest, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="card-body">
                    <div id="unpaid_leaves_repeater" class="mb-4">
                        ...
                        <div id="unpaid_leaves_container">
                            <?php $unpaid_leaves = old('unpaid_leaves', $dailyStatus->unpaid_leaves ?? []); ?>
                            <?php $__currentLoopData = $unpaid_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.employee_leave_item', ['type' => 'unpaid_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="absences_repeater" class="mb-4">
                        ...
                        <div id="absences_container">
                            <?php $absences = old('absences', $dailyStatus->absences ?? []); ?>
                            <?php $__currentLoopData = $absences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $absence): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.dated_leave_item', ['type' => 'absences', 'index' => $index, 'leave' => $absence, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="long_leaves_repeater" class="mb-4">
                        ...
                        <div id="long_leaves_container">
                            <?php $long_leaves = old('long_leaves', $dailyStatus->long_leaves ?? []); ?>
                            <?php $__currentLoopData = $long_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.dated_leave_item', ['type' => 'long_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="sick_leaves_repeater" class="mb-4">
                        ...
                        <div id="sick_leaves_container">
                            <?php $sick_leaves = old('sick_leaves', $dailyStatus->sick_leaves ?? []); ?>
                            <?php $__currentLoopData = $sick_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.dated_leave_item', ['type' => 'sick_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="bereavement_leaves_repeater" class="mb-4">
                        ...
                        <div id="bereavement_leaves_container">
                            <?php $bereavement_leaves = old('bereavement_leaves', $dailyStatus->bereavement_leaves ?? []); ?>
                            <?php $__currentLoopData = $bereavement_leaves; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $leave): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.employee_leave_item', ['type' => 'bereavement_leaves', 'index' => $index, 'leave' => $leave, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    ...
                    <div id="custom_usages_repeater" class="mb-4">
                        ...
                        <div id="custom_usages_container">
                            <?php $custom_usages = old('custom_usages', $dailyStatus->custom_usages ?? []); ?>
                            <?php $__currentLoopData = $custom_usages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $usage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('daily_statuses.partials.custom_usage_item', ['type' => 'custom_usages', 'index' => $index, 'usage' => $usage, 'employees' => $employees], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" id="total_required" name="total_required" value="<?php echo e(old('total_required', $dailyStatus->total_required ?? 86)); ?>"
                                   class="form-control" required oninput="updateStats()">
                            <?php $__errorArgs = ['total_required'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <p id="total_employees_display" class="input-group-text-custom">
                                <?php echo e($totalEmployees ?? \App\Models\Employee::where('is_active', 1)->count()); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="organizer_employee_id" name="organizer_employee_id" class="form-control select2-init" required onchange="updateOrganizerName()">
                            ...
                            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($employee->id); ?>" <?php echo e(old('organizer_employee_id', $dailyStatus->organizer_employee_id ?? '') == $employee->id ? 'selected' : ''); ?>>
                                    <?php echo e($employee->name); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['organizer_employee_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="text-danger mt-1"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        <input type="hidden" id="organizer_employee_name_input" name="organizer_employee_name" value="<?php echo e(old('organizer_employee_name', $dailyStatus->organizer_employee_name ?? '')); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
                ...
                <a href="<?php echo e(route('daily-statuses.index')); ?>" class="btn btn-secondary">
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        ...
        const employeesData = <?php echo json_encode($employees->keyBy('id'), 15, 512) ?>;
        const daysOfWeek = {
            'Sunday': 'الأحد',
            'Monday': 'الإثنين',
            'Tuesday': 'الثلاثاء',
        ...
        async function convertToHijri(gregorianDate) {
            try {
                const response = await fetch('<?php echo e(route("daily-statuses.get-hijri-date-and-day")); ?>?date=' + gregorianDate);
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\xampp\htdocs\kadm-drgham\resources\views/daily_statuses/form.blade.php ENDPATH**/ ?>