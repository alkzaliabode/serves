...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> | <?php echo $__env->yieldContent('title', 'لوحة التحكم'); ?></title>
    ...
    <style>
        ...
        body {
            ...
            background-image: url('<?php echo e(config('app.background_image_url')); ?>');
    ...
    <main class="app-main">
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0"><?php echo $__env->yieldContent('page_title', 'الصفحة'); ?></h3>
                    </div>
                    <div class="col-sm-6">
