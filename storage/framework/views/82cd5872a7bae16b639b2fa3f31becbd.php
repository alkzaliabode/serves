...
<?php $__env->startSection('title', 'لوحة مهام الشُعبة الخدمية'); ?>

<?php $__env->startSection('page_title', 'لوحة مهام الشُعبة الخدمية'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="kanban-board" id="kanban-board">
            <?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusKey => $columnTitle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="kanban-column <?php echo e($statusKey); ?>" data-status="<?php echo e($statusKey); ?>">
                    <h2 class="column-header"><?php echo e($columnTitle); ?></h2>
                    <div class="kanban-cards" id="kanban-column-<?php echo e($statusKey); ?>">
                        <?php $__currentLoopData = ($groupedTasks[$statusKey] ?? collect())->sortBy('order_column'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            
                            <?php echo $__env->make('kanban.partials.task-card', ['task' => $task, 'statuses' => $statuses, 'units' => $units, 'priorities' => $priorities], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="create_priority" name="priority">
                                    <?php $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php if($key == 'medium'): ?> selected <?php endif; ?>><?php echo e($value); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            createTaskForm.addEventListener('submit', function(e) {
                ...
                fetch('<?php echo e(route('service-tasks.store')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.admin_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kadm-drgham\resources\views/kanban/service-tasks-board.blade.php ENDPATH**/ ?>