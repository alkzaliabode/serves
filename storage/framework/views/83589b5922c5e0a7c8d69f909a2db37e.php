    ...
    <div class="login-container">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <div class="form-floating mb-4">
                <input type="email" class="form-control" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username" placeholder=" "> 
...
<?php /**PATH C:\xampp\htdocs\kadm-drgham\resources\views/auth/static-login.blade.php ENDPATH**/ ?>