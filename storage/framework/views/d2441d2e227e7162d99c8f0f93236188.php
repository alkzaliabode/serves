...
<?php $__env->startSection('page_title', __('الملف الشخصي')); ?> 
...
<?php $__env->startSection('breadcrumb'); ?> 
    ...
    <li class="breadcrumb-item active"><?php echo e(__('الملف الشخصي')); ?></li>
        ...
        <div class="space-y-6"> 
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('صورة الملف الشخصي')); ?></h3>
                </div>
                <div class="card-body">
                    
                    <form id="profile-photo-form" action="<?php echo e(route('user-profile-photo.update')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="profile-photo-container">
                            <label for="profile_photo_input" class="profile-photo-wrapper">
                                <img id="profile_photo_preview"
                                     src="<?php echo e(Auth::user()->profile_photo_url ?? 'https://placehold.co/150x150/cccccc/ffffff?text=U'); ?>"
                            ...
                            <div class="photo-buttons">
                                <button type="button" class="btn btn-primary" onclick="document.getElementById('profile_photo_input').click()">
                                    <i class="fas fa-upload mr-1"></i> <?php echo e(__('تغيير الصورة')); ?>

                                </button>
                                <?php if(Auth::user()->profile_photo_path): ?>
                                    <button type="button" class="btn btn-danger" id="remove-photo-button">
                                        <i class="fas fa-trash mr-1"></i> <?php echo e(__('إزالة الصورة')); ?>
            ...
            <div class="card card-primary card-outline mt-4">
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('معلومات الملف الشخصي')); ?></h3>
                </div>
                <div class="card-body">
                    <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4063518175-0', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div class="card card-primary card-outline mt-4"> 
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('تحديث كلمة المرور')); ?></h3>
                </div>
                <div class="card-body">
                    <?php
$__split = function ($name, $params = []) {
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4063518175-1', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <div class="card card-danger card-outline mt-4"> 
                <div class="card-header">
                    <h3 class="card-title"><?php echo e(__('حذف الحساب')); ?></h3>
                </div>
                <div class="card-body">
                    <?php
$__split = function ($name, $params = []) {
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4063518175-2', $__slots ?? [], get_defined_vars());
            ...
            if (removePhotoButton) {
                removePhotoButton.addEventListener('click', function() {
                    if (confirm('هل أنت متأكد أنك تريد إزالة صورة ملفك الشخصي؟')) {
                        ...
                        form.method = 'POST';
                        form.action = '<?php echo e(route('user-profile-photo.destroy')); ?>'; // Define this route in web.php
...
<?php echo $__env->make('layouts.admin_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\kadm-drgham\resources\views/profile/edit.blade.php ENDPATH**/ ?>