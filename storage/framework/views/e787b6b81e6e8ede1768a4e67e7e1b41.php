...
<head>
    ...
    <title>تقرير الموقف اليومي - <?php echo e(\Carbon\Carbon::parse($dailyStatus->date)->format('Y-m-d')); ?></title>
    ...
    <div class="print-container" lang="ar" dir="rtl">
        <div class="content-wrapper">
            <div class="header-print">
                ...
                <img src="<?php echo e(asset('images/another_logo.png')); ?>" 
                        alt="شعار المؤسسة 2"
                        class="logo"
            ...
            <table>
                <tr>
                    ...
                    <td colspan="2">التاريخ: <strong> (<?php echo e(\Carbon\Carbon::parse($dailyStatus->date)->format('d/m/Y')); ?>)</strong></td>
                </tr>
            </table>
...
</html><?php /**PATH C:\xampp\htdocs\kadm-drgham\resources\views/daily_statuses/print_standalone.blade.php ENDPATH**/ ?>